  ...
  return (
    <div className="flex h-full min-h-full w-full bg-background">
      ...
      <div className="flex min-w-0 flex-1 p-3">
        <main className="flex min-w-0 flex-1 flex-col overflow-hidden rounded-2xl border border-white/[0.08] bg-panel shadow-[0_12px_40px_rgba(0,0,0,0.55)]">
          ...
          <div className="w-full flex-1 overflow-y-auto px-8 py-7">{children}</div>
        </main>
      </div>
      <Toaster />
    </div>
